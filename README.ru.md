...
> **Форк ConvyrTech.** Оригинальный Choirboy-лор и исследовательский харнесс
> сохранены. В `prompt.md`, `security-posture.md`, `user.md`, `lore.md` и
> `research/22–26` добавлен отдельный санитизированный слой ConvyrTech. Он
> различает проверенные, сообщённые пользователем и планируемые кейсы и не
> содержит ключей, частных имён или воспроизводимых деталей живых целей.
